...
<header>
    <nav>
        <ul>
            ...
            <li><a href="../../public/login.php" class="contrast">Cerrar Sesión</a></li>
        </ul>
    </nav>
</header>
...
?>
    ...
    <article>
        ...
        <section class="navigation">
            <h3>Navegación</h3>
            <p>Volver al <a href="../../public/index.php">Menú de Inicio</a></p>
        </section>
    </article>
</main>

<footer>
    <p>Pulse <a href="../../public/login.php" class="contrast">aquí</a> para cerrar sesión.</p>
</footer>
